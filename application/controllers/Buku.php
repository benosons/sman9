...
class Buku extends CI_Controller {
	...
	public function listbuku()
	{
		...
		{
			$this->content['js'] = 'assets/js/action/buku/listbuku.js';
			$this->twig->display('admin/buku/listbuku.html', $this->content);
		}else{
			redirect("dashboard");
		}
	}
	...
	public function rekapbuku()
	{
		if ( $this->logged && $this->role == '10' || $this->role == '20')
		{
			$this->content['js'] = 'assets/js/action/buku/rekapbuku.js';
			$this->twig->display('admin/buku/rekapbuku.html', $this->content);
		}else{
			redirect("dashboard");
		}
	}
	...
	public function peminjaman()
	{
		if ( $this->logged && $this->role == '10' || $this->role == '20')
		{
			$this->content['js'] = 'assets/js/action/buku/peminjaman.js';
			$this->twig->display('admin/buku/peminjaman.html', $this->content);
		}else{
			redirect("dashboard");
		}
	}
